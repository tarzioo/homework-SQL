...
SELECT COUNT(models) FROM models where brand_name = 'Ford';
...
SELECT models.name, brand_name, founded FROM models FULL JOIN brands ON models.brand_name = brands.name WHERE year = 1960;
